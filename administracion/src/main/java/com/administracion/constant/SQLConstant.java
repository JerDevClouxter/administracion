...
public static final String SELECT_EMPRESAS_BASE = "SELECT e.ID_EMPRESA,e.NIT_EMPRESA,e.RAZON_SOCIAL FROM EMPRESAS e ORDER BY e.RAZON_SOCIAL";
	...
	public static final String SQL_GET_ROLES =
		"SELECT "
			...
			+ "(SELECT STRING_AGG(DISTINCT REC.NOMBRE,','ORDER BY REC.NOMBRE) FROM ROLES_RECURSOS_ACCIONES RRE JOIN RECURSOS REC ON(REC.ID_RECURSO=RRE.ID_RECURSO)WHERE RRE.ID_ROL=R.ID_ROL) AS RECURSOS "
			+ "FROM ROLES R "
